...
class ClientTest(unittest.TestCase):
  ...
  def test_getRatio_calculateRatio(self):
    prices = [{'price_a': 100, 'price_b': 50}, {'price_a': 50, 'price_b': 100}, 
              {'price_a': 50, 'price_b': 50}, {'price_a': 1, 'price_b': 1}]
